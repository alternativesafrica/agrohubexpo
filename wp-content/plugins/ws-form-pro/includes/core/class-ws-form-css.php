...
<?php } ?>
	...
	padding: <?php self::e($form_spacing_vertical . $unit_of_measurement . ' ' . $form_spacing_horizontal . $unit_of_measurement); ?>;
<?php if ($form_transition) { ?>
	transition: background-color <?php self::e($form_transition_speed); ?>, border-color <?php self::e($form_transition_speed); ?>, background-image <?php self::e($form_transition_speed); ?>, box-shadow <?php self::e($form_transition_speed); ?>;
<?php } ?>
	width: 100%;
}
...
select.wsf-field ~ .select2-container .select2-selection--multiple:hover {
	background-image: url('data:image/svg+xml,<svg%20width%3D"10"%20height%3D"5"%20viewBox%3D"169%20177%2010%205"%20xmlns%3D"http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg"><path%20fill%3D"<?php echo urlencode($form_hover_color); ?>"%20fill-rule%3D"evenodd"%20d%3D"M174%20182l5-5h-10"%2F><%2Fsvg>');
}
<?php } ?>
<?php } ?>
...
select.wsf-field ~ .select2-container--default .select2-selection--multiple .select2-selection__choice {
	font-size: <?php self::e($form_font_size_small . $unit_of_measurement); ?>;
	margin: 0 <?php self::e($spacing_extra_small . $unit_of_measurement . ' ' . $spacing_extra_small . $unit_of_measurement); ?> 0;
}
...
select.wsf-field ~ .select2-container .select2-selection--multiple .select2-selection__rendered {
	color: <?php self::e($form_color); ?>;
	line-height: <?php self::e($line_height); ?> !important;
	padding-left: 0;
	padding-right: 0;
}
...
.wsf-select2-dropdown .select2-search--dropdown {
	margin-bottom: <?php self::e($spacing_extra_small . $unit_of_measurement); ?>;
	padding: <?php self::e($spacing_extra_small . $unit_of_measurement . ' ' . $spacing_extra_small . $unit_of_measurement); ?> 0;
}
...
<?php if ($form_border) { ?>
	border-top: <?php self::e($form_border_width . $unit_of_measurement . ' ' . $form_border_style . ' ' . $form_border_color); ?>;
<?php } else { ?>
	border-top: none;
<?php } ?>
	color: <?php self::e($form_color); ?>;
	...
	font-weight: <?php self::e($font_weight); ?>;
	margin-bottom: 0;
	padding: <?php self::e($spacing_extra_small . $unit_of_measurement); ?>;
}
...
.wsf-select2-dropdown .select2-results .select2-results__option--highlighted[aria-selected] {
	...
	color: <?php self::e($form_background_color); ?>;
}
...
input[type=radio].wsf-field.wsf-switch + label.wsf-label {
	padding-left: <?php self::e((($checkbox_size * 2) - ($form_border_width * 4)  + $spacing_extra_small) . $unit_of_measurement); ?>;
	position: relative;
}
...
<?php if ($form_focus) { ?>
<?php if ($form_box_shadow) { ?>
.wsf-validated canvas.wsf-field.wsf-invalid:focus {
...
.wsf-validated input[type=file].wsf-field:invalid + label.wsf-label:after {
	border-color: <?php self::e($form_error_border_color); ?>;
}
<?php } ?>
<?php } ?>
...
<?php if ($form_focus) { ?>
<?php if ($form_box_shadow) { ?>
.wsf-validated input[type=file].wsf-field:invalid:focus + label.wsf-label {
	box-shadow: 0 0 0 <?php self::e($form_box_shadow_width . $unit_of_measurement); ?> <?php self::e(WS_Form_Common::hex_lighten_percentage($form_error_border_color, 85)); ?>;
}
<?php } ?>
<?php } ?>
...
<?php if ($form_transition) { ?>
	transition: box-shadow <?php self::e($form_transition_speed); ?>;
<?php } ?>
...
.wsf-field-wrapper[data-type='price_range'] datalist {
	display: block;
	position: relative;
	margin: 0 <?php self::e(($range_size / 2) . $unit_of_measurement); ?> 0;
	width: calc(100% - <?php self::e($range_size . $unit_of_measurement); ?>);
}
...
.wsf-field-wrapper[data-type='price_range'] datalist option {
	...
	padding: 0;
	position: absolute;
	top: -<?php self::e(($range_size + $spacing_extra_small) . $unit_of_measurement); ?>;
	z-index: -1;
}
...
.wsf-field-wrapper[data-type='price_range'] datalist option::before {
	...
	display: block;
	height: <?php self::e($range_size . $unit_of_measurement); ?>;
	margin-left: -<?php self::e($form_border_width . $unit_of_measurement); ?>;
	width: <?php self::e($form_border_width . $unit_of_measurement); ?>;
}
...
.wsf-field-wrapper[data-type='price_range'] datalist option::after {
	...
	position: absolute;
	left: 50%;
	top: <?php self::e($range_size . $unit_of_measurement); ?>;
...
select.wsf-field ~ .select2-container--default .select2-selection--multiple .select2-selection__choice {
	margin: 0 0 <?php self::e($spacing_extra_small . $unit_of_measurement . ' ' . $spacing_extra_small . $unit_of_measurement); ?>;
}
...
input[type=radio].wsf-field.wsf-switch + label.wsf-label {
	padding-left: 0;
	padding-right: <?php self::e((($checkbox_size * 2) - ($form_border_width * 4)  + $spacing_extra_small) . $unit_of_measurement); ?>;
}
