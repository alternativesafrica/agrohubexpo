		...
		//								'class_single_required'			=> array('required'),
						...
						'field_types'		=> array(
							...
							'file' 	=> array(
								...
								'mask_field_label'			=>	sprintf('<label id="#label_id" for="#id" data-label-target="span"#attributes><span class="form-file-text">#label</span><span class="form-file-button">#file_button_label</span></label>'),
