	...
	class WS_Form_Config_Admin extends WS_Form_Config {
		...
		public static function get_settings_form_admin() {
			...
			$settings_form_admin = array(
								...
								'basic'	=> array(
									...
									'fieldsets'	=>	array(
										...
										array(
											...
											'meta_keys'	=> array('submit_on_enter', 'invalid_field_focus', 'submit_lock', 'submit_unlock', 'submit_reload', 'submit_show_errors', 'form_action')
										),
				...
				// Conditional
				'conditional' => $ws_form_config_conditional->get_settings_conditional(),
