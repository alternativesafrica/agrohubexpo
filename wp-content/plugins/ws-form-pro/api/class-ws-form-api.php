<?php
	...
	class WS_Form_API {
		...
		public function api_rest_api_init() {
			...
			register_rest_route(WS_FORM_RESTFUL_NAMESPACE, '/form/stat/get_chart_data/', array('methods' => 'GET', 'callback' => array($plugin_api_form_stat, 'api_get_chart_data'), 'permission_callback' => function () { return WS_Form_Common::can_user('manage_options_wsform'); }));

			register_rest_route(WS_FORM_RESTFUL_NAMESPACE, '/form/(?P<form_id>[\d]+)/stat/add_view/', array('methods' => 'POST', 'callback' => array($plugin_api_form_stat, 'api_add_view'), 'permission_callback' => function () { return true; }));
			...
			register_rest_route(WS_FORM_RESTFUL_NAMESPACE, '/migrate/field_mapping/', array('methods' => 'POST', 'callback' => array($plugin_api_migrate, 'api_field_mapping'), 'permission_callback' => function () { return WS_Form_Common::can_user('import_form'); }));
