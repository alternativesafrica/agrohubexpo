...
//			self::wp_scripts_debug();
		...
		public function enqueue() {
			...
			if(!$this->enqueued_js_select2 && apply_filters('wsf_enqueue_js_select2', $this->enqueue_js_select2)) {
				...
				// External - Select2 - JS
				wp_enqueue_script($this->plugin_name . '-external-select2-js', $external['select2_js'], array('jquery'), null, $jquery_footer);

				// External - Select2 - CSS
				wp_enqueue_style($this->plugin_name . '-external-select2-css', $external['select2_css'], array(), $this->version, 'all');
