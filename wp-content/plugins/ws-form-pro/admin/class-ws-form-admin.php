		...
		public function enqueue_styles($hook) {
			...
			switch($hook) {
				...
				case $this->hook_suffix_form_sub :
					...
					// CSS - Framework
					wp_enqueue_style($this->plugin_name . '-css-layout', WS_Form_Common::get_api_path('helper/ws_form_css_admin', sprintf('_wpnonce=%s', wp_create_nonce('wp_rest'))), array(), $this->version . '.' . WS_FORM_EDITION, 'all');
				...
				case $this->hook_suffix_form_edit :
					...
					if(!wp_style_is('select2', 'enqueued')) {
						...
						wp_enqueue_style('select2', WS_FORM_PLUGIN_DIR_URL . 'shared/css/external/select2/select2.min.css', array(), '4.0.13', 'all');
					}
		...
		public function enqueue_scripts($hook) {
			...
			switch($hook) {
				...
				case $this->hook_suffix_form_edit :
					...
					if(!wp_script_is('select2', 'enqueued')) {
						...
						wp_enqueue_script('select2', WS_FORM_PLUGIN_DIR_URL . 'shared/js/external/select2/select2.full.min.js', array('jquery'), $this->version, true);
					}
			...
			if(!$disable_count_submit_unread) {
				...
				$ws_form_admin_count_submit_read_settings = array(
					...
					'count_submit_unread_ajax_url' => sprintf('%s?_wpnonce=%s', WS_Form_Common::get_api_path('helper/count_submit_unread'), wp_create_nonce('wp_rest'))
				);
