		...
		$(function() {
			...
			$('[data-action="wsf-framework-detect"]').click(function() {
				...
				wsf_obj.framework_detect(function(framework) {
					...
					// Show info message
					wsf_obj.message('<?php esc_html_e('Your current theme does not contain a recognized framework. Using WS Form as the form framework.', 'ws-form'); ?>', true, 'notice-info');
...
?>
<input type="button" class="wsf-button" data-action="wsf-form-stat-reset" data-for="wsf_<?php echo esc_attr($field); ?>" value="<?php esc_attr_e('Reset', 'ws-form'); ?>"<?php
