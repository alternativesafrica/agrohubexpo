		...
		public function get_svg_from_form_object($form_object, $label = false) {
			...
			foreach($fields as $field) {
				...
				if(isset($field_type_buttons[$field['type']])) {
					...
					// Price Span - Label
					$svg_field .= '<text fill="' . $skin_color_default . '" transform="translate(' . $label_inside_x . ',' . $label_inside_y . ')" class="wsf-wizard-label">' . $field['label'] . '</text>';
					...
					switch($field['type']) {
						...
						case 'section_label' :
							...
							// Legend
							$svg_field = '<text fill="' . $skin_color_default . '" transform="translate(' . ($offset_x) . ',' . $legend_font_size . ')" class="wsf-wizard-legend">' . $field['label'] . '</text>';
						...
						case 'message' :
							...
							// Message - Label
							$svg_field .= '<text transform="translate(' . $label_inside_x . ',' . $label_inside_y . ')" class="wsf-wizard-label" fill="' . $message_fill_label . '">' . $field['label'] . '</text>';
						...
						case 'file' :
							...
							$svg_field .= '<rect x="' . $button_xpos . '" y="' . $label_offset_y . '" fill="' . $skin_color_default_lighter . '" stroke="' . $skin_color_default_lighter . '" stroke-width="' . $skin_border_width . '" rx="' . $skin_border_radius . '" width="' . ($field_width / 4) . '" height="' . $field_height . '"/>';
